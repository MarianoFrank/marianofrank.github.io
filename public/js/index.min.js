  ...
  btnsForSound.forEach(btnForSound => {
    btnForSound.addEventListener("click", e => {
      if (btnForSound.tagName === "A") {
        e.preventDefault();
        setTimeout(() => {
          if (btnForSound.getAttribute("target") === "_blank") {
            window.open(btnForSound.href, "_blank");
            return;
          }
          window.location = btnForSound.href;
        }, 200);
      }
    });
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  btnCopy.addEventListener("click", async function () {
    try {
      await navigator.clipboard.writeText("marianofrank@hotmail.com");
      copyTippy.setContent("Copiado ✅");
    } catch {
      copyTippy.setContent("Ocurrió un error ⛔");
    }
  });
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  zoomElements.forEach(element => {
    ...
    element.addEventListener("mousemove", e => {
      ...
      // Ajustar el rango de -10 a 110 para permitir espacio adicional alrededor del contenedor
      var x = offsetX / zoomer.offsetWidth * 120 - 10;
      var y = offsetY / zoomer.offsetHeight * 120 - 10;

      // Limitar los valores de x e y al rango de -10 a 110
      x = Math.max(-10, Math.min(110, x));
      y = Math.max(-10, Math.min(110, y));
      zoomer.style.backgroundPosition = x + "% " + y + "%";

      //ocultamos la imagen estatica
      element.querySelector(".project-img-explain").style.opacity = 0;
    });
    element.addEventListener("mouseleave", e => {
      element.querySelector(".project-img-explain").style.opacity = 1;
      element.style.backgroundImage = "none";
    });
  });
});
...
/* harmony import */ var _zoomImages_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./zoomImages.js */ "./src/js/zoomImages.js");
...
//DarkMode
document.addEventListener("DOMContentLoaded", () => {
  let dark = parseInt(localStorage.getItem("dark-mode")) ? 1 : 0;
  if (dark) {
