...
window.addEventListener("DOMContentLoaded", () => {
  const inputAndTextareaElements = document.querySelectorAll(".input-label input, .input-label textarea");
  inputAndTextareaElements.forEach(inputElement => {
    const labelElement = inputElement.nextElementSibling;
    inputElement.addEventListener("focus", () => {
      if (labelElement && labelElement.tagName === "LABEL") {
        labelElement.classList.add("labelActive");
      }
    });
    inputElement.addEventListener("blur", () => {
      // Verificar si el input está vacío antes de quitar la clase
      if (labelElement && labelElement.tagName === "LABEL" && inputElement.value === "") {
        labelElement.classList.remove("labelActive");
      }
    });
    inputElement.addEventListener("input", () => {
      // Agregar la clase si hay texto presente
      if (labelElement && labelElement.tagName === "LABEL" && inputElement.value !== "") {
        labelElement.classList.add("labelActive");
      }
    });
...
window.addEventListener("DOMContentLoaded", () => {
  //Sonido Click
  const sound_click = new Audio("./public/sounds/click.wav");
  sound_click.volume = 0.5;
  const btnsForSound = document.querySelectorAll(".btn , .btn_icon");
  const handleClickEvent = btn => {
    sound_click.play();
    btn.classList.add("clicked");
  };
  btnsForSound.forEach(btnForSound => {
    btnForSound.addEventListener("click", e => {
      if (btnForSound.tagName === "A") {
        e.preventDefault();
        setTimeout(() => {
          window.location.href = btnForSound.href;
        }, 200);
      }
    });
    btnForSound.addEventListener("mousedown", () => handleClickEvent(btnForSound));
    btnForSound.addEventListener("touchstart", () => handleClickEvent(btnForSound));
    btnForSound.addEventListener("click", () => {
      setTimeout(() => {
        btnForSound.classList.remove("clicked");
      }, 30);
    });
    btnForSound.addEventListener("mouseleave", () => {
      setTimeout(() => {
        btnForSound.classList.remove("clicked");
      }, 30);
    });
  ...
  //Sonido Inputs
  const sound_swosh = new Audio("./public/sounds/swoosh.wav");
  sound_swosh.volume = 0.5;
  const inputsForSound = document.querySelectorAll("input , textarea");
  inputsForSound.forEach(inputForSound => {
    inputForSound.addEventListener("focus", () => {
      if (!inputForSound.nextElementSibling.classList.contains("labelActive")) {
        sound_swosh.play();
      }
    });
  });
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const copyTippy = (0,tippy_js__WEBPACK_IMPORTED_MODULE_1__["default"])("#copy", {
    content: "Copiar",
    hideOnClick: false
  })[0];
  const btnCopy = document.querySelector("#copy .btn");
  btnCopy.addEventListener("click", function () {
    copyTippy.setContent("Copiado ✅");
  });
  btnCopy.addEventListener("mouseleave", function () {
    setTimeout(() => {
      copyTippy.setContent("Copiar");
    }, 500);
  });
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const wordsToType = document.querySelector("span[words]").getAttribute("words").split(",");
  const typer = document.querySelector("span[words]");
  const typingSpeed = parseInt(typer.getAttribute("typing-speed")) || 70;
  const typingDelay_write = parseInt(typer.getAttribute("typing-delay-write")) || 700;
  const typingDelay_remove = parseInt(typer.getAttribute("typing-delay-remove")) || 700;
  ...
  function type() {
    ...
    if (currentCharacterIndex < wordToType.length) {
      ...
      //una vez esta escrito espera el delay para borrar
      setTimeout(erase, typingDelay_remove);
    }
  }
  function erase() {
    let wordToType = wordsToType[currentWordIndex % wordsToType.length];
    if (currentCharacterIndex > 0) {
      ...
      currentWordIndex++;
      //una vez borrado espera el delay para arrancar a escribir
      setTimeout(type, typingDelay_write);
    }
  }
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sonidoClick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sonidoClick.js */ "./src/js/sonidoClick.js");
/* harmony import */ var _typingTextEffect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./typingTextEffect.js */ "./src/js/typingTextEffect.js");
/* harmony import */ var _tooltips_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tooltips.js */ "./src/js/tooltips.js");
/* harmony import */ var _inputDinamic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inputDinamic.js */ "./src/js/inputDinamic.js");
...
font-size:1.5rem;`;
console.log("%cPortfolio de Mariano F.", estiloConsola);
})();
